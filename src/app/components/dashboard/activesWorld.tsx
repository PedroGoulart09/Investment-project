  ...
  return (
    <section className='bg-slate-50 flex justify-center flex-col text-center gap-10 py-14'>
        <p className='font-bold'>+ de 300 ativos disponíveis</p>
            ...
            <h3 className='text-2xl text colorText'>e indústrias estabelecidas a emergentes em franca ascensão, escolha entre mais de uma dúzia <br /> de rotas diferentes para um investimento inteligente.</h3>
       <Graphic />
    </section>
  )
}
